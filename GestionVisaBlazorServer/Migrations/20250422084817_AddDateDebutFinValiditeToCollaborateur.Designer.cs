...
namespace GestionVisaBlazorServer.Migrations
{
    ...
    [Migration("20250422084817_AddDateDebutFinValiditeToCollaborateur")]
    partial class AddDateDebutFinValiditeToCollaborateur
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeplacementCollaborateur", b =>
                {
                    ...
                    b.HasIndex("DeplacementId");

                    b.ToTable("DeplacementCollaborateurs");
                });

            modelBuilder.Entity("GestionVisaBlazorServer.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DeplacementCollaborateur", b =>
                {
                    b.HasOne("Collaborateur", "Collaborateur")
                        .WithMany("DeplacementsCollaborateur")
                        .HasForeignKey("CollaborateurId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GestionVisaBlazorServer.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Collaborateur", b =>
                {
                    ...
                    b.Navigation("DeplacementsCollaborateur");
                });
